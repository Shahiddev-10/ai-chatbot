...
const appHome = configuration.paths.myChatbots;
  ...
  return (
    <AuthPageLayout heading={<Trans i18nKey={'auth:signInHeading'} />}>
      ...
      <If condition={configuration.auth.providers.emailPassword}>
        <span className={'font-Outfit text-lg font-normal text-gray_text-1'}>
      ...
      <div
        className={
          'lg:text-l flex justify-center px-7 pb-10 font-Outfit text-gray_text-1'
        }
      >
        <p className={'flex space-x-1'}>
          ...
          <Link
            className={'text-primary-800 underline dark:text-primary-500'}
            href={signUpPath}
          >
