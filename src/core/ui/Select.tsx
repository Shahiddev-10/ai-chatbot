...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={classNames(
      `flex h-[60px] w-full items-center justify-between space-x-2.5
        rounded-md border !bg-transparent px-2.5 py-1 transition-all
        ...
        disabled:opacity-50 dark:border-black-200 dark:bg-black-400
         dark:hover:border-black-100 dark:hover:bg-black-300 focus:!border-gray_bg-2 focus:shadow-field-shadow active:!border-gray_bg-2 active:shadow-field-shadow`,
      className
    )}
    {...props}
  >
...
>(({ className, children, sideOffset = 4, ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={classNames(
        `animate-in fade-in-250 relative z-50 ml-6 -mt-2 w-[50%]  min-w-[8rem] overflow-hidden border border-transparent
          border-t-gray-50 bg-white shadow-xl dark:border-black-200 dark:bg-black-300  lg:rounded-md`,
        className
      )}
