...
const defaultColor: Color = `custom`;
        ...
        <InnerButtonContainerElement href={href} disabled={props.disabled}>
          <span
            className={classNames(
              `flex w-max  place-content-center items-center rounded bg-none font-Outfit`,
              sizesClassName
            )}
          >
...
function InnerButtonContainerElement({
  ...
  return (
    <span className={`flex w-full place-content-center items-center`}>
      {children}
    </span>
  );
}
...
function getClassNameBuilder() {
  return cva(
    [
      `flex items-center justify-center font-medium outline-none transition-all focus:ring-2 ring-offset-1 dark:focus:ring-offset-transparent disabled:cursor-not-allowed disabled:opacity-50 font-Mulish font-normal text-btncolor-0 hover:bg-[#FA9D00] hover:text-[#000000]`,
    ],
    {
      variants: {
        color: {
      ...
      active:bg-primary-500/30 dark:hover:bg-primary-500/20 dark:active:bg-primary-500/30`,
        },
        {
          color: 'custom',
          variant: 'flat',
          className: `bg-btncolor-0 outline-none dark:focus:ring-0 !text-black-400 hover:bg-btncolor-0
          active:bg-btncolor-0 `,
        },
        {
          color: 'danger',
          variant: 'flat',
          className: `bg-red-500/10 text-red-500 dark:focus:ring-red-500/70
    active:bg-red-500/30 hover:bg-red-500/20 dark:active:bg-red-500/30 hover:text-white`,
        },
      ],
      defaultVariants: {
        color: 'primary',
