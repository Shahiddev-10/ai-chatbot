      ...
      >
        ...
        >
          <div className="h-full min-h-screen px-4 text-center">
            ...
            <div
              className={`inline-block max-h-[90%] w-full max-w-${size} transform overflow-auto rounded-xl bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-black-400`}
            >
              <div className={'flex flex-col space-y-4'}>
                ...
                <If condition={useCloseButton}>
                  <DialogPrimitiveClose asChild>
                    <IconButton
                      className={
                        'absolute -top-0 right-4 flex h-5 w-5 items-center'
                      }
                      label={'Close Modal'}
