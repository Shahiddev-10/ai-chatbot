  ...
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={classNames(
      'flex cursor-default select-none items-center space-x-2.5 rounded-md' +
        ' justify-between px-2 py-1.5 font-Outfit text-sm font-medium outline-none',
      inset && 'pl-8',
      clickable &&
  ...
  <DropdownMenuPrimitive.SubContent
    ...
    className={classNames(
      'animate-in slide-in-from-left-1 z-50 min-w-[8rem] overflow-hidden' +
        ' rounded-md border border-gray-100 bg-white p-1 !shadow-none' +
...
>(({ className, sideOffset = 4, alignOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={classNames(
        'animate-in data-[side=bottom]:slide-in-from-top-2 md:w-maxs w-max sm:mt-3 md:mt-6' +
          ' data-[side=top]:slide-in-from-bottom-2 z-50 min-w-[8rem]' +
          ' overflow-hidden border border-transparent border-t-gray-50' +
          ' bg-white p-1 shadow-none dark:border-black-200 dark:bg-black-300' +
  ...
  <DropdownMenuPrimitive.Item
    ...
    className={classNames(
      'relative flex h-11 w-full select-none items-center rounded-md lg:h-8' +
        ...
        ' font-Outfit data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      {
        'pl-8': inset,
