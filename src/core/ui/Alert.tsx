...
function getClassNameBuilder() {
  return cva(
    [
      `p-4 rounded relative flex items-center font-Outfit justify-between text-black-300 rounded-lg text-sm`,
    ],
    {
      variants: {
        type: {
          success: `bg-green-50 dark:bg-green-500/30 dark:text-green-500 text-green-900`,
          info: `bg-blue-50 dark:bg-blue-500/30 dark:text-blue-500 text-blue-900`,
          error: `bg-red-50 dark:bg-red-500/30 dark:text-red-500 text-red-900`,
